...
$content = '
    ...
    <div>
        <p>Тьма, пришедшая со Средиземного моря, накрыла ненавидимый прокуратором город. 
        ...
        Хасмонейский дворец с бойницами, базары, караван-сараи, переулки, пруды...</p>
...
<body>
    <header>
        <!-- Согласно Рис. 3 добавляем класс ins -->
        <div class="content ins">
            <?php echo $header; ?>
        </div>
    </header>

    <!-- Согласно Рис. 3 добавляем класс ins родителю и контенту -->
    <div class="main ins">
        <div class="content ins">
            <?php echo $content; ?>
        </div>
